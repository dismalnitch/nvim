...
map("n", "pi", "<cmd>Lspsaga preview_definition", { desc = "Preview Definition" })
map(
  "n",
  "<Space>xi",
...
map("n", "<Space>[", "<cmd>resize get(0, 'width') - 2<cr>", { desc = "Decrease Window Width" })
map("n", "<Space>]", "<cmd>resize get(0, 'width') + 2<cr>", { desc = "Increase Window Width" })
map("n", "<Space>+", "<cmd>resize get(0, 'height') - 2<cr>", { desc = "Decrease Window Height" })
map("n", "<Space>-", "<cmd>resize get(0, 'height') + 2<cr>", { desc = "Increase Window Height" })
